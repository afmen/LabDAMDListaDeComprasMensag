...
class MicroservicesClient {
    ...
    async addItemToList(listId, itemData) {
        try {
            ...
            // CORREÇÃO: Adicionar /lists/ extra pois o Gateway remove /api/lists
            // O serviço espera /lists/:id/items, então enviamos /api/lists/lists/:id/items
    ...
    async getListSummary(listId) {
        try {
            ...
            // CORREÇÃO: Adicionar /lists/ extra (mesma lógica de addItemToList)
